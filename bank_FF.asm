...
tbl_C00B:
- D 2 - - - 0x01C01B 07:C00B: 00        .byte $00   ; 00
- D 2 - - - 0x01C01C 07:C00C: 5A        .byte $5A   ; 01
- D 2 - - - 0x01C01D 07:C00D: 40        .byte $40   ; 02
- D 2 - - - 0x01C01E 07:C00E: 2E        .byte $2E   ; 03
- D 2 - - - 0x01C01F 07:C00F: 13        .byte $13   ; 04
- - - - - - 0x01C020 07:C010: 5A        .byte $5A   ; 05
- D 2 - - - 0x01C021 07:C011: 76        .byte $76   ; 06
- D 2 - - - 0x01C022 07:C012: 94        .byte $94   ; 07
- D 2 - - - 0x01C023 07:C013: 80        .byte $80   ; 08
- D 2 - - - 0x01C024 07:C014: A6        .byte $A6   ; 09
- D 2 - - - 0x01C025 07:C015: A6        .byte $A6   ; 0A
...
bra_C0C0:
C - - - - - 0x01C0D0 07:C0C0: A5 B4     LDA ram_btn_press
...
C - - - - - 0x01C0DA 07:C0CA: A5 B6     LDA ram_btn_hold
C - - - - - 0x01C0DC 07:C0CC: 29 02     AND #con_btn_Left
C - - - - - 0x01C0DE 07:C0CE: F0 04     BEQ bra_C0D4
C - - - - - 0x01C0E0 07:C0D0: A9 07     LDA #$07
C - - - - - 0x01C0E2 07:C0D2: D0 08     BNE bra_C0DC
bra_C0D4:
C - - - - - 0x01C0E4 07:C0D4: A5 B6     LDA ram_btn_hold
C - - - - - 0x01C0E6 07:C0D6: 29 01     AND #con_btn_Right
...
bra_C166:
C - - - - - 0x01C176 07:C166: B9 B4 00  LDA ram_btn_press,Y
C - - - - - 0x01C179 07:C169: C9 01     CMP #con_btn___A
C - - - - - 0x01C17B 07:C16B: F0 04     BEQ bra_C171
C - - - - - 0x01C17D 07:C16D: C9 03     CMP #con_btn___B
...
bra_C197:
C - - - - - 0x01C1A7 07:C197: B9 B4 00  LDA ram_btn_press,Y
C - - - - - 0x01C1AA 07:C19A: C9 00     CMP #con_btn___nothing
C - - - - - 0x01C1AC 07:C19C: F0 31     BEQ bra_C1CF
C - - - - - 0x01C1AE 07:C19E: B9 B6 00  LDA ram_btn_hold,Y
C - - - - - 0x01C1B1 07:C1A1: 29 08     AND #con_btn_Up
C - - - - - 0x01C1B3 07:C1A3: F0 04     BEQ bra_C1A9
C - - - - - 0x01C1B5 07:C1A5: A9 06     LDA #$06
C - - - - - 0x01C1B7 07:C1A7: D0 1F     BNE bra_C1C8
bra_C1A9:
C - - - - - 0x01C1B9 07:C1A9: B9 B6 00  LDA ram_btn_hold,Y
C - - - - - 0x01C1BC 07:C1AC: 29 04     AND #con_btn_Down
C - - - - - 0x01C1BE 07:C1AE: F0 04     BEQ bra_C1B4
C - - - - - 0x01C1C0 07:C1B0: A9 03     LDA #$03
C - - - - - 0x01C1C2 07:C1B2: D0 14     BNE bra_C1C8
bra_C1B4:
C - - - - - 0x01C1C4 07:C1B4: B9 B6 00  LDA ram_btn_hold,Y
C - - - - - 0x01C1C7 07:C1B7: 29 02     AND #con_btn_Left
C - - - - - 0x01C1C9 07:C1B9: F0 04     BEQ bra_C1BF
C - - - - - 0x01C1CB 07:C1BB: A9 08     LDA #$08
C - - - - - 0x01C1CD 07:C1BD: D0 09     BNE bra_C1C8
bra_C1BF:
C - - - - - 0x01C1CF 07:C1BF: B9 B6 00  LDA ram_btn_hold,Y
C - - - - - 0x01C1D2 07:C1C2: 29 01     AND #con_btn_Right
C - - - - - 0x01C1D4 07:C1C4: F0 09     BEQ bra_C1CF
C - - - - - 0x01C1D6 07:C1C6: A9 01     LDA #$01
bra_C1C8:
C - - - - - 0x01C1D8 07:C1C8: 18        CLC
C - - - - - 0x01C1D9 07:C1C9: 79 F4 00  ADC ram_cursor_fighter,Y
C - - - - - 0x01C1DC 07:C1CC: 99 F4 00  STA ram_cursor_fighter,Y
bra_C1CF:
C - - - - - 0x01C1DF 07:C1CF: B9 F4 00  LDA ram_cursor_fighter,Y
...
C - - - - - 0x01C1E9 07:C1D9: 99 F4 00  STA ram_cursor_fighter,Y
bra_C1DC:
...
sub_CA4C:
C - - - - - 0x01CA5C 07:CA4C: B9 75 00  LDA ram_0075,Y
...
bra_CA57:
C - - - - - 0x01CA67 07:CA57: B9 74 00  LDA ram_0074,Y
C - - - - - 0x01CA6A 07:CA5A: C5 78     CMP ram_0078
C - - - - - 0x01CA6C 07:CA5C: 90 0A     BCC bra_CA68_RTS
bra_CA5E:
C - - - - - 0x01CA6E 07:CA5E: B9 74 00  LDA ram_0074,Y
C - - - - - 0x01CA71 07:CA61: 85 78     STA ram_0078
C - - - - - 0x01CA73 07:CA63: B9 75 00  LDA ram_0075,Y
...
C - - - - - 0x01CB91 07:CB81: C9 70     CMP #con_btns_debug
...
bra_CB8C:
C - - - - - 0x01CB9C 07:CB8C: 8D 56 70  STA $7006
...
C - - - - - 0x01D14B 07:D13B: C9 01     CMP #con_btn___A
...
C - - - - - 0x01D39C 07:D38C: 29 03     AND #con_btn_Right + con_btn_Left
...
C - - - - - 0x01D3CC 07:D3BC: 29 03     AND #con_btn_Right + con_btn_Left
...
C - - - - - 0x01D4E1 07:D4D1: C9 01     CMP #con_btn___A
...
C - - - - - 0x01D57A 07:D56A: C9 03     CMP #con_btn___B
...
C - - - - - 0x01D5DD 07:D5CD: C9 01     CMP #con_btn___A
...
C - - - - - 0x01D657 07:D647: 29 03     AND #con_btn_Right + con_btn_Left
...
C - - - - - 0x01D7C6 07:D7B6: A5 B6     LDA ram_btn_hold
C - - - - - 0x01D7C8 07:D7B8: D0 04     BNE bra_D7BE
C - - - - - 0x01D7CA 07:D7BA: A5 B7     LDA ram_btn_hold + 1
...
C - - - - - 0x01D7F7 07:D7E7: A5 B6     LDA ram_btn_hold
C - - - - - 0x01D7F9 07:D7E9: C9 C0     CMP #con_btn_B + con_btn_A
C - - - - - 0x01D7FB 07:D7EB: F0 0B     BEQ bra_D7F8
bra_D7ED:
C - - - - - 0x01D7FD 07:D7ED: AD 4E 05  LDA ram_054E
C - - - - - 0x01D800 07:D7F0: F0 11     BEQ bra_D803
C - - - - - 0x01D802 07:D7F2: A5 B7     LDA ram_btn_hold + 1
C - - - - - 0x01D804 07:D7F4: C9 C0     CMP #con_btn_B + con_btn_A
...
C - - - - - 0x01DA79 07:DA69: B9 41 91  LDA tbl_0x015150 + 1,Y
...
C - - - - - 0x01DAF6 07:DAE6: B9 01 91  LDA tbl_0x015110 + 1,Y
...
C - - - - - 0x01DB26 07:DB16: B9 21 91  LDA tbl_0x015130 + 1,Y
...
C - - - - - 0x01DB57 07:DB47: B9 61 91  LDA tbl_0x015170 + 1,Y
...
bra_DDEA:
C - - - - - 0x01DDFA 07:DDEA: A5 B6     LDA ram_btn_hold
C - - - - - 0x01DDFC 07:DDEC: C9 70     CMP #con_btns_debug
...
- D 2 - - - 0x01DF9F 07:DF8F: 1C        .byte $1C   ; 
...
- - - - - - 0x01E052 07:E042: A9 28     LDA #$28
- - - - - - 0x01E054 07:E044: 8D 06 20  STA $2006
- - - - - - 0x01E057 07:E047: A9 00     LDA #$00
...
C - - - - - 0x01E0A7 07:E097: A9 00     LDA #$00
...
C - - - - - 0x01E5D3 07:E5C3: D0 A2     BNE bra_E567_reading_table_loop
bra_E5C5:
...
C - - - - - 0x01EBF2 07:EBE2: B9 01 85  LDA tbl_0x012510 + 1,Y
...
C - - - - - 0x01ED85 07:ED75: BD 84 ED  LDA tbl_ED83 + 1,X
...
C - - - - - 0x01F147 07:F137: B9 74 00  LDA ram_0074,Y
C - - - - - 0x01F14A 07:F13A: 85 A5     STA ram_00A5
C - - - - - 0x01F14C 07:F13C: B9 75 00  LDA ram_0075,Y
...
bra_F319:
C - - - - - 0x01F329 07:F319: A5 B6     LDA ram_btn_hold
C - - - - - 0x01F32B 07:F31B: 29 10     AND #con_btn_Start
...
C - - - - - 0x01F45D 07:F44D: C9 01     CMP #con_btn___A
C - - - - - 0x01F45F 07:F44F: F0 04     BEQ bra_F455
C - - - - - 0x01F461 07:F451: C9 03     CMP #con_btn___B
...
loc_F468:
C D 3 - - - 0x01F478 07:F468: B5 B4     LDA ram_btn_press,X
...
C - - - - - 0x01F483 07:F473: B5 B6     LDA ram_btn_hold,X
C - - - - - 0x01F485 07:F475: 29 0F     AND #con_btns_Dpad
...
bra_F4A0:
loc_F4A0:
C D 3 - - - 0x01F4B0 07:F4A0: B5 B6     LDA ram_btn_hold,X
C - - - - - 0x01F4B2 07:F4A2: 29 0F     AND #con_btns_Dpad
...
C - - - - - 0x01F5C4 07:F5B4: B9 3B 00  LDA ram_p1_fighter,Y
C - - - - - 0x01F5C7 07:F5B7: 18        CLC
C - - - - - 0x01F5C8 07:F5B8: 69 09     ADC #$09
C - - - - - 0x01F5CA 07:F5BA: 20 85 E8  JSR sub_E885
C - - - - - 0x01F5CD 07:F5BD: B9 3B 00  LDA ram_p1_fighter,Y
...
C - - - - - 0x01F608 07:F5F8: B9 B6 00  LDA ram_btn_hold,Y
C - - - - - 0x01F60B 07:F5FB: 29 D0     AND #con_btn_Start + con_btn_B + con_btn_A
...
C - - - - - 0x01F628 07:F618: C9 01     CMP #con_btn___A
C - - - - - 0x01F62A 07:F61A: F0 04     BEQ bra_F620
C - - - - - 0x01F62C 07:F61C: C9 03     CMP #con_btn___B
...
C - - - - - 0x01F64E 07:F63E: C9 02     CMP #con_btn___not_A
...
bra_F6DD:
C - - - - - 0x01F6ED 07:F6DD: C9 03     CMP #con_btn___B
...
C - - - - - 0x01F712 07:F702: C9 03     CMP #con_btn___B
...
C - - - - - 0x01F71D 07:F70D: B9 E6 00  LDA ram_00E6,Y
...
C - - - - - 0x01F971 07:F961: B9 A6 F9  LDA tbl_F9A5 + 1,Y
...
C - - - - - 0x01FAC4 07:FAB4: A9 3F     LDA #$3F
C - - - - - 0x01FAC6 07:FAB6: 8D 06 20  STA $2006
C - - - - - 0x01FAC9 07:FAB9: A9 00     LDA #$00
...
C - - - - - 0x01FB3C 07:FB2C: 79 74 00  ADC ram_0074,Y
C - - - - - 0x01FB3F 07:FB2F: 99 74 00  STA ram_0074,Y
C - - - - - 0x01FB42 07:FB32: B9 75 00  LDA ram_0075,Y
C - - - - - 0x01FB45 07:FB35: 69 00     ADC #$00
C - - - - - 0x01FB47 07:FB37: 99 75 00  STA ram_0075,Y
...
bra_FB63:
C - - - - - 0x01FB73 07:FB63: 99 00 00  STA ram_0000,Y
...
C - - - - - 0x01FD47 07:FD37: A9 00     LDA #con_btn___nothing
...
bra_FD8C:
C - - - - - 0x01FD9C 07:FD8C: A9 09     LDA #con_btn___Dpad
